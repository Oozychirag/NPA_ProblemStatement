...
using Nuance.NPA.Infrastructure.Source;
...
namespace Nuance.NPA.API.Source
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddDbContext<SourceContext>(options => options.UseInMemoryDatabase(databaseName: "Source"));

            services.AddTransient<ISourceDomainService, SourceDomainService>();
